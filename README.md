...
[![Build status](https://img.shields.io/github/actions/workflow/status/calonmerc/PiFireOS/build.yaml)](https://github.com/calonmerc/PiFireOS/actions/workflows/build.yaml)
